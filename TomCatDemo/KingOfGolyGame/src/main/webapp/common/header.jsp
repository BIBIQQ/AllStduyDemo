    ...
    <div class="hm-inner clearfix">
        ...
        <div class="hm-inner-r r">
            <div class="box">
                ...
                <c:if test="${user.userName == null}"> <a href="javascript:;" id="login" class="to-login">游客登录</a>
                    <a href="/register.jsp">【新用户注册】</a></c:if>

                <c:if test="${user.userName != null}">欢迎 <a href="/showUserByIdServlet"  class="to-login" style="color: #70aad6">${user.userName}</a>
