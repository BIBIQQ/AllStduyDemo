...
<div class="hm-header">
    <div class="hm-inner clearfix">
        ...
        <div class="hm-header-b">
            ...
            <a href="/indextHtmlServlet">首页</a><span>></span>个人信息
        </div>
    </div>
</div>
        ...
        <div class="user-info clearfix">
            ...
            <div class="user-info-r r">
                <ul class="clearfix hd">
                    <li class="cur"><a href="/showUserByIdServlet">个人信息</a></li>
                    <li><a href="/userPwd.jsp">修改密码</a></li>
                </ul>

                <%--enctype="multipart/form-data"--%>
                <form action="/modifiyUserServlet" method="post"  >
                    <input type="hidden" value="${user.userId}" name="userId">
                    <ul class="bd">
                        <li class="clearfix">
                            <div class="info-l"><i class="red">*</i>用户名：</div>
                            <div class="info-r"><input type="text" class="txt" value="${user.userName}"  name="userName" readonly="readonly"/></div>
                        </li>
                        <li class="clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="info-r">
                                ...
                                <span style="color:red;">${Modify_msg}</span>
                            </div>
                        </li>
                    </ul>
                </form>
