...
<div class="hm-body hm-body-bgc">
    <div class="hm-inner">
        ...
        <ul class="hm-bbs-nav border-lrb clearfix">
            ...
            <c:forEach items="${allArticleZone}" var="allArticleZone">
                <li>
                        <%--<li class="current">--%>
                    <a href="/findArticleByIdServlet?id=${allArticleZone.zoneId}"><em></em>${allArticleZone.zoneName}
                    </a>
                </li>
            </c:forEach>
        </ul>
            ...
            <div class="list-view l">
                <ul>
                    <c:forEach items="${article}" var="article">
                        <c:if test="${article.isTop == 1}"> <li class="clearfix ding"></c:if>
                        <c:if test="${article.isTop == 0}"> <li class="clearfix"></c:if>
                        <div class="hm-index-title">
                            <c:if test="${article.isTop == 1}"> <i class="set-to-top">顶</i></c:if> <a
                                href="/getArticleServlet">${article.title}</a>
                        </div>
