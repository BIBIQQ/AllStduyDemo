...
public class a {
    public static void main(String[] args) {
         //1.获取代码生成器的对象
                 ...
                 globalConfig.setOutputDir(System.getProperty("user.dir")+"/cutknife/src/main/java");    //设置代码生成位置
                 ...
                 strategyConfig.setInclude("ap_cut_knife");  //设置当前参与生成的表名，参数为可变参数
                 strategyConfig.setInclude("ap_user");  //设置当前参与生成的表名，参数为可变参数
